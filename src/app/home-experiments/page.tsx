        ...
        <div className="py-24 bg-card/30 backdrop-blur-xl">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-foreground mb-4">Why Choose UpFetch?</h2>
              ...
              {[
                {
                  ...
                  salary: '$180k',
                  increase: '+$45k',
                  story: "I was stuck in a junior role for 3 years. UpFetch's AI matching showed me I was ready for senior positions. Within 2 weeks, I had 5 interviews and landed my dream job at Stripe!",
                  avatar: '👩‍💻',
